...
while True:
    ...
    if ultrasonic < 10:
          ...
          dist =  'alert :' ' Dumpster poundage getting high, Time to collect :)40 %'
                
    elif ultrasonic < 60 and ultrasonic > 41:
          dist = 'alert :' 'dumpster is above 60%'
    elif ultrasonic < 80 and ultrasonic > 61:
          dist =  'alert :' 'Not in risk state  20 %'
   
                
                
                
    if load == "90 %" or ultrasonic == "90 %":
          warn  = 'alert :' ' Risk warning'
                
    elif load == "60 %" or ultrasonic == "60 %":
                
          warn = 'alert: 60% accuracy'
    else :
          warn =  'alert: below 20% trash'    
